...
cp tests/scan_timing.py tests/scan_timing_result.json tests/scan_post_persist.py tests/scan_post_persist_result.json tests/scan_tie_survival_floor.py tests/tie_survival_floor_result.json tests/harness_loop_log.jsonl \
