...
\textbf{(3) The sustainability of structural mutual aid is a hypothesis to test, not a conclusion.} The timebank's post-withdrawal persistence is prescribed in the rules layer by post\_persist and did not arise spontaneously in the LLM layer (focal elders rebound by \PFocRebTb pp; \PFocActRebTb pp excluding silent months). ``Casework to open, timebank to sustain'' should therefore be posed as a follow-up hypothesis and tested against a post\_persist $=0$ control to see whether it depends on that parameter.
...
\begin{table}[H]
\centering\small
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.05\columnwidth}>{\raggedright\arraybackslash}p{0.52\columnwidth}>{\raggedright\arraybackslash}p{0.37\columnwidth}@{}}
\toprule
