...
\begin{itemize}
  ...
  \item \textbf{Mechanism scans and loop}: \texttt{tests/scan\_timing.py}, \texttt{tests/scan\_post\_persist.py}, \texttt{tools/harness\_loop.py} (preregistered headers + per-round JSONL audit logs).
